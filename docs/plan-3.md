...
- GitFlow-based workflow established;
- CI foundation added;
- `auth-api` and `data-api` are present and testable;
- JWT authentication flow implemented in `auth-api`;
- Maven tests pass in both modules.
